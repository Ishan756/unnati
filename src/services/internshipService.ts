...
export const mockInternships: Internship[] = [
  // Dummy internships within 200km of Bhopal and nearby cities
  {
    id: 'bhopal-1',
    title: 'Frontend Developer Intern',
    company: 'Bhopal Web Solutions',
    description: 'Work on modern web interfaces for local businesses in Bhopal.',
    location: { lat: 23.2599, lng: 77.4126, city: 'Bhopal' },
  ...
  },
  {
    ...
    company: 'Bhopal Analytics',
    description: 'Analyze local datasets and build predictive models for Bhopal startups.',
    location: { lat: 23.2595, lng: 77.4020, city: 'Bhopal' },
  ...
  },
  {
    ...
    company: 'Bhopal Apps',
    description: 'Build mobile apps for local services in Bhopal and nearby towns.',
    location: { lat: 23.2876, lng: 77.3826, city: 'Bhopal' },
  ...
  },
  {
    ...
    company: 'Bhopal Backend Solutions',
    description: 'Develop REST APIs for local businesses in Bhopal region.',
    location: { lat: 23.1736, lng: 77.4342, city: 'Bhopal' },
  ...
  },
  {
    ...
    company: 'Bhopal AI Labs',
    description: 'Research and prototype AI models for local applications in Bhopal.',
    location: { lat: 23.3136, lng: 77.3936, city: 'Bhopal' },
  ...
  // Nearby cities within 200km of Bhopal
  {
    id: 'indore-1',
    title: 'Marketing Intern',
    company: 'Indore Marketers',
    description: 'Assist in digital marketing campaigns for Indore-based companies.',
    location: { lat: 22.7196, lng: 75.8577, city: 'Indore' },
  ...
  },
  {
    ...
    company: 'Vidisha Creatives',
    description: 'Write blogs and articles for Vidisha startups.',
    location: { lat: 23.5251, lng: 77.8061, city: 'Vidisha' },
  ...
  },
  {
    ...
    title: 'Sales Intern',
    company: 'Harda Sales',
    description: 'Support sales operations for Harda-based businesses.',
    location: { lat: 22.3397, lng: 77.1025, city: 'Harda' },
  ...
  },
  {
    ...
    company: 'Hoshangabad Designs',
    description: 'Create graphics for local businesses in Hoshangabad.',
    location: { lat: 22.7536, lng: 77.7225, city: 'Hoshangabad' },
  ...
  },
  {
    id: 'sehore-1',
    title: 'HR Intern',
    company: 'Sehore HR Solutions',
    description: 'Assist in HR operations for Sehore-based companies.',
    location: { lat: 23.2020, lng: 77.0851, city: 'Sehore' },
  ...
  // 40 dummy internships, each mapped to a tech skill from onboarding
  {
    ...
    description: 'Work with modern frontend frameworks to build scalable web interfaces.',
  ...
  },
  {
    ...
    title: 'Backend Developer Intern',
    company: 'CloudCore',
    description: 'Develop REST APIs and microservices using backend technologies.',
    location: { lat: 12.9716, lng: 77.5946, city: 'Bangalore' },
    tags: ['Backend Development', 'API Development & Integration'],
    type: 'remote',
    duration: '4 months',
    stipend: '₹12,000/month',
  ...
  },
  {
    ...
    company: 'StackMakers',
    description: 'End-to-end web app development using full stack technologies.',
  ...
  },
  {
    ...
    title: 'Mobile App Developer Intern',
    company: 'AppCrafters',
    description: 'Build cross-platform mobile apps using industry-standard tools.',
    location: { lat: 22.5726, lng: 88.3639, city: 'Kolkata' },
    tags: ['Mobile App Development', 'Cross-platform Development'],
    type: 'onsite',
    duration: '5 months',
  ...
  },
  {
    ...
    company: 'MLWorks',
    description: 'Build and train ML models using modern ML frameworks.',
  ...
  },
  {
    ...
    tags: ['Data Science', 'Data Analytics', 'Data Visualization'],
    type: 'onsite',
    duration: '5 months',
    stipend: '₹13,000/month',
  ...
  },
  {
    ...
    company: 'Insightful',
    description: 'Work with BI tools to analyze business data.',
  ...
  },
  {
    ...
    tags: ['DevOps & Cloud Computing', 'Continuous Integration/Continuous Deployment (CI/CD)'],
    type: 'hybrid',
    duration: '6 months',
  ...
  },
  {
    ...
    location: { lat: 19.0760, lng: 72.8777, city: 'Mumbai' },
    tags: ['Cybersecurity', 'Web Security', 'Network Administration'],
    type: 'onsite',
    duration: '4 months',
    stipend: '₹15,000/month',
